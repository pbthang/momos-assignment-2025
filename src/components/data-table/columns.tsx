...
export const columns: ColumnDef<DataRecord>[] = [
    ...
    },
    {
        ...
        id: "checkbox",
        header: ({ column }) => (
            <SortableHeader column={column} title="Checkbox" />
        ),
        cell: ({ row }) => (
            <Checkbox checked={row.original.checkbox} disabled />
        ),
    },
    {
        accessorKey: "date",
    ...
    },
    {
        ...
        id: "select",
        header: ({ column }) => (
            <SortableHeader column={column} title="Select" />
        ),
        sortingFn: (rowA, rowB) => {
        ...
        cell: ({ row }) => {
            ...
            return (
                <ColorBadge color={color} label={row.original.select?.name} />
            );
        },
    },
    {
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <ColorBadge color={color} label={row.original.status?.name} />
            );
        },
    },
];
